...
<div class="container">
	<div id="samp">
		...
		<form action="searchengine4politics.php" method="POST" name="sec-search3">
		<p  id="searchinput">
		...
		<div id="postsclass3">
         ...
         <?php
            ...
            if(isset($_POST['searchbtn4'])) {
                ...
                $sql = "SELECT * FROM audios WHERE category='Politics' and caption LIKE '%$search%'";
                ...
                if($queryResult > 0) {
					...
					echo "<script>location.replace('Politics4.php');</script>";
                }
            }else{
