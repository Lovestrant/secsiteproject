...
<html>
        ...
        <div class="container">
                <div id="samp">
                        ...
                        <form action="searchengine1business.php" method="POST" name="sec-search1">
                        <p  id="searchinput">
              ...
              <?php
                            ...
                            if(isset($_POST['searchbtn1'])) {
                                ...
                                if(!empty($_POST['search1'])){
                                    ...
                                    $sql = "SELECT * FROM secstories WHERE category='Business' and textpost LIKE '%$search%'";
                                    ...
                                    echo "<script>location.replace('Business1.php');</script>";
                                }
                            }else{
