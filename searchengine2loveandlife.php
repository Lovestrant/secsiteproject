...
<div class="container">
	<div id="samp">
		...
		<form action="searchengine2loveandlife.php" method="POST" name="sec-search2">
		<p  id="searchinput">
		...
		<div id="postsclass3">
         ...
         <?php
            ...
            if(isset($_POST['searchbtn2'])) {
                ...
                $sql = "SELECT * FROM pictures WHERE category='loveandlife' and caption LIKE '%$search%'";
                ...
                if($queryResult > 0) {
                    ...
                    echo "<script>location.replace('Loveandlife2.php');</script>";
                }
            }else{
