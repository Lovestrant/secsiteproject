...
<div class="container">
	<div id="samp">
		...
		<form action="searchengine2gamesandsports.php" name="sec-search2" method="POST" >
		<p  id="searchinput">
...
<div id="secvideos" style="width: 1000px; margin-left: 50px;">
                    ...
                    <p>
                        <h2 class="col-sm-12" id="secpicsh" style="color:brown;">SecPics(Games & sports)</h2>
	...
	<h4 id="newlabel0">New</h4>
		...
		<?php
		include('db.php');
		$sql="SELECT * FROM pictures WHERE category='Gamesandsports' ORDER BY ID DESC LIMIT 3";
		...
		<button class="btn btn-success" id= "morebtn" style="margin-bottom: 10%; margin-left: 20%;font-size: 30px;">See more posts</button>
			...
			$("#morebtn").click(function() {
				...
				$("#postsclass2").load("loadpicturepostsgamesandsports.php", {
...
<script>
		...
		function uploadFile(){
			...
			ajax.open("POST", "Gamesandsports2.php");
			ajax.send(formdata);
		}
