...
<div class="container">
	<div id="samp">
		...
		<form action="searchengine2others.php" method="POST" name="sec-search2">
		<p  id="searchinput">
		...
		<div id="postsclass3">
         ...
         <?php
            ...
            if(isset($_POST['searchbtn2'])) {
                ...
                $sql = "SELECT * FROM pictures WHERE category='others' and caption LIKE '%$search%'";
                ...
                if($queryResult > 0) {
                    ...
                    echo "<script>location.replace('Others2.php');</script>";
                }
            }else{
