...
<div class="container">
	<div id="samp">
		...
		<form action="searchengine2others.php" name="sec-search2" method="POST">
		<p  id="searchinput">
...
<div id="secvideos" style="width: 1000px; margin-left: 50px;">
                    ...
                    <p>
                        <h2 class="col-sm-12" id="secpicsh" style="color:brown;">SecPics(Others)</h2>
