...
<div class="container">
	<div id="samp">
		...
		<form action="searchengine2entertainment.php" method="POST" name="sec-search2">
		<p  id="searchinput">
         ...
         <?php
            ...
            if(isset($_POST['searchbtn2'])) {
             ...
             if(!empty($_POST['search2'])){
                ...
                $sql = "SELECT * FROM pictures WHERE category='entertainment' and caption LIKE '%$search%'";
                ...
                if($queryResult > 0) {
                    ...
                    echo "<script>location.replace('Entertainment2.php');</script>";
                }
