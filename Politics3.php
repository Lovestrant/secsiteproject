...
if (isset($_POST['upload'])) {
	if(!empty($_FILES['file']['name'])){
		...
		echo "<script>location.replace('Politics3.php');</script>";
	}
...
<div class="container">
	<div id="samp">
		...
		<form action="searchengine3politics.php" method="POST" name="sec-search3">
		<p  id="searchinput">
...
<div id="secvideos" style="width: 1000px; margin-left: 50px;">
                    ...
                    <p>
                        <h2 class="col-sm-12" id="secvidsh" style="color:brown;">SecVids(Politics)</h2>
...
<label  class="form-label" for="secvidsupload"  id="labels"> Attach videos here</label>
   ...
   <textarea type="text" class="form-control"  name="textarea3" id="textarea3" cols="50" rows= "1" placeholder="Caption your video/audio" style="width:90%;border-radius: 20px; margin-left: 5%;"></textarea><br>
...
<div id="postsclass3" style="margin-top: -15%;margin-left: 0%; text-align: centre;">
	...
	<?php
		include('db.php');
		$sql="SELECT * FROM videos WHERE category='Politics' ORDER BY ID DESC LIMIT 2";
		...
		<button class="btn btn-success" id= "morebtn" style="margin-bottom: 10%; margin-left: 20%;font-size: 30px;">See more posts</button>
			...
			$("#morebtn").click(function() {
				...
				$("#postsclass3").load("loadvideopostspolitics.php", {
