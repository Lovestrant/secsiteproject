...
<div id="secvideos" style="width: 1000px; margin-left: 50px;">
                    ...
                    <p>
                        <h2 class="col-sm-12" id="secvidsh" style="color:brown;">SecVids(Entertainment)</h2>
...
<div id="postsclass3" style="margin-top: -15%;margin-left: 0%; text-align: centre;">
	...
	<?php
		include('db.php');
		$sql="SELECT * FROM videos WHERE category='Entertainment' ORDER BY ID DESC LIMIT 2";
...
<button class="btn btn-success" id= "morebtn" style="margin-bottom: 10%; margin-left: 20%;font-size: 30px;">See more posts</button>
			...
			$("#morebtn").click(function() {
				...
				$("#postsclass3").load("loadvideopostsentertainment.php", {
...
<script>
		...
		function uploadFile(){
			...
			ajax.open("POST", "Entertainment3.php");
			ajax.send(formdata);
		}
